...
//设置网络接通标志位
void setNetworkFlag(int iValue)
{
     pStation->downData.bFlagNetwork = iValue;
}
...
int getNetworkFlag( )
{
     return pStation->downData.bFlagNetwork;
}
//获取远程下载命令驱动号
...
int getIsAllUpdate()
{
    ...
    for (i = 0; i < pStation->iDriverNum; i++)
    {
        ...
        {
          //  printf("lf_debug the func getIsAllUpdate is here..........\n");
